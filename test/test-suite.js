...
describe('Test Suite', function () {
  ...
  describe('Adding and Removing Foods', function () {
    ...
    it('edit food - change unit', function () {
      ...
      return app.client.click("#AdminTabBtn")
      .click("#AdminTabBtn1")
      .click('#t1TableUnit1')
      ...
      }).should.eventually.deep.equal({ "unit": "tsp", "shop": "Tesco", "foodType": "starch", "allergens": [] });
  ...
  describe('Adding a Menu',function(){
    ...
    it('add a new menu',function(){
      ...
      return app.client.click('#AddMenuTabBtn')
      ...
      .click('#add_weekend_menu').then(function(){
        ...
        vegetarians:null,
        meals:[
          {mealType:"dinner",date:"2018-08-03T00:00:00.000Z",recipes:[]},
          {mealType:"breakfast",date:"2018-08-04T00:00:00.000Z",recipes:[
            {recipeTitle:"Standard Breakfast",morv:"b"}
          ]},
          {mealType:"snack",date:"2018-08-04T00:00:00.000Z",recipes:[]},
          {mealType:"lunch",date:"2018-08-04T00:00:00.000Z","recipes":[]},
          {mealType:"dinner",date:"2018-08-04T00:00:00.000Z","recipes":[]},
          {mealType:"breakfast",date:"2018-08-05T00:00:00.000Z","recipes":[
            {recipeTitle:"Standard Breakfast",morv:"b"}
          ]},
          {mealType:"lunch",date:"2018-08-05T00:00:00.000Z",recipes:[]}
        ]}
      );
    });
    ...
    it('add a new meal',function(){
      ...
      return app.client.click('#EditMenuTabBtn')
      ...
      .then(function(){
        ...
        vegetarians:null,
        meals:[
          {mealType:"lunch",date:"2018-08-03T00:00:00.000Z",recipes:[]},
          {mealType:"dinner",date:"2018-08-03T00:00:00.000Z",recipes:[]},
          {mealType:"breakfast",date:"2018-08-04T00:00:00.000Z",recipes:[
            {recipeTitle:"Standard Breakfast",morv:"b"}
          ]},
      ...
      it('add 3 recipes to the menu',function(){
        ...
        .then(function(){
          ...
          meals:[
            {mealType:"lunch",date:"2018-08-03T00:00:00.000Z",recipes:[
              {recipeTitle:"Roux",morv:"b"},
              {recipeTitle:"Test Veg",morv:"v"},
              {recipeTitle:"Test Dessert",morv:"b"}
            ]},
            {mealType:"dinner",date:"2018-08-03T00:00:00.000Z",recipes:[]},
            {mealType:"breakfast",date:"2018-08-04T00:00:00.000Z",recipes:[
              {recipeTitle:"Standard Breakfast",morv:"b"}
  ...
  describe('Edit and View Menu',function(){
    ...
    it('correct meal title for sunday breakfast',function(){
      return app.client.click('#ViewMenuTabBtn')
  ...
  describe('Shopping List',function(){
    ...
    it('check flour amount', function(){
      return app.client.click('#ShoppingTabBtn')
  ...
  describe('People',function(){
    ...
    it('delete and add specials row',function(){
      return app.client.click('#PeopleTabBtn')
